...
function HeroShortener() {
  ...
  if (status === 'success') {
    return (
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-[#131B2E] border border-blue-500/40 p-8 rounded-3xl shadow-2xl max-w-2xl mx-auto w-full text-left">
    ...
    <div className="bg-[#131B2E] rounded-3xl p-8 shadow-2xl border border-gray-700/60 relative overflow-hidden">
      ...
      <div className="bg-[#0B0F19] p-6 rounded-2xl border border-gray-800 relative z-10 space-y-4">
        ...
        <div className="flex justify-between items-center pt-2">
          <span className="text-white font-black text-lg">What Smart Link Saves You</span>
          <span className="text-green-400 font-black text-3xl">${wastedSpend.toLocaleString()}</span>
        </div>
      </div>
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen text-white font-sans selection:bg-blue-500/30 overflow-x-hidden bg-[#0B0F19]">
      ...
      {/* NAVBAR */}
      <nav className={"fixed top-0 left-0 right-0 z-50 transition-all duration-300 " + (scrolled ? 'bg-[#0B0F19]/95 backdrop-blur-md border-b border-gray-800 shadow-md' : 'bg-transparent')}>
      ...
      {/* 1. HERO — Sleek Dark Mode */}
      <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0B0F19] pt-24 pb-16 lg:pt-32 lg:pb-24">
        {/* Ambient Radial Glow */}
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-blue-600/10 rounded-full blur-[140px] pointer-events-none"></div>
        <div className="absolute top-1/3 right-1/4 w-[450px] h-[450px] bg-purple-600/10 rounded-full blur-[140px] pointer-events-none"></div>
      ...
      {/* 5. ROI CALCULATOR — UNCROPPED FUNNEL LAPTOP CARD */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              {/* Funnel laptop showcase card — UNCROPPED */}
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-700 bg-[#131B2E] p-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex justify-center">
              <div className="relative max-w-xs sm:max-w-sm rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-700 bg-[#131B2E]">
