...
export default function TrackingTab({
  ...
  // ✅ CRITICAL: Handle undefined functions
  if (!addPixel || !removePixel || !updatePixel) {
    return (
      <div className="flex justify-center items-center py-12">
        <div className="text-red-500">
          Error: Tracking functions not available
        </div>
      </div>
    );
  }

  // ✅ SAFE: Create safe references
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      try {
                        ...
                        console.error('Error updating pixel platform:', error);
                      }
                    }}
