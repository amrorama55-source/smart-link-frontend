      ...
      <section className="py-16 sm:py-24 bg-gray-50 dark:bg-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 flex justify-center">
            ...
            <div className="trustpilot-widget" data-locale="en-US" data-template-id="53aa8807dec7e10d38f59f32" data-businessunit-id="69f7390bebbd3c000d06bf18" data-style-height="150px" data-style-width="100%" data-token="b67fd1c8-4724-4922-ae25-038862ea786a">
