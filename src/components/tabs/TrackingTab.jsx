    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white">Tracking Pixels</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Add conversion tracking pixels</p>
          </div>
        </div>
        <button
          type="button"
          onClick={addPixel}
          className="px-3 py-1 bg-indigo-600 text-white rounded-lg text-sm hover:bg-indigo-700 transition flex items-center gap-1 touch-target"
        >
      ...
      <div className="p-4 bg-blue-50 dark:bg-blue-900/10 rounded-lg border border-blue-200 dark:border-blue-800/30">
        ...
        <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1 list-disc list-inside">
          ...
          <li>Track conversions in your platform's dashboard</li>
